...
contract('TaskRegister', async function([_, wallet1, wallet2, wallet3, wallet4, wallet5, wallet6, wallet7, wallet8, wallet9, wallet10]) {
    ...
    it("should solve first of 2 tasks", async function() {
        wallet10.should.be.equal("0x0d65ad88abf613060af3c14a3c33c5142eae687b");
        ...
        // A3F24A728BEFEEC8C597F74EDE3BCFEC84131C71580DCFD07A1616C9FF536833
        // 76677A9066508541B906945C7EDE71F91D530C76D5706D5728A0D6DCD93455CC
        await taskRegister.createBitcoinAddressPrefixTask("1PhoneX", "0xA3F24A728BEFEEC8C597F74EDE3BCFEC84131C71580DCFD07A1616C9FF536833", "0x76677A9066508541B906945C7EDE71F91D530C76D5706D5728A0D6DCD93455CC", 0, { value: 100 });
        const {receipt} = await taskRegister.createBitcoinAddressPrefixTask("1Phone", "0xA3F24A728BEFEEC8C597F74EDE3BCFEC84131C71580DCFD07A1616C9FF536833", "0x76677A9066508541B906945C7EDE71F91D530C76D5706D5728A0D6DCD93455CC", 0, { value: 100 });
        const taskId = web3.toBigNumber(receipt.logs[0].topics[1]);
    ...
    it("should solve last of 2 tasks", async function() {
        wallet10.should.be.equal("0x0d65ad88abf613060af3c14a3c33c5142eae687b");
    ...
    it("should solve first of 3 tasks", async function() {
        wallet10.should.be.equal("0x0d65ad88abf613060af3c14a3c33c5142eae687b");
        ...
        const {receipt} = await taskRegister.createBitcoinAddressPrefixTask("1Phone", "0xA3F24A728BEFEEC8C597F74EDE3BCFEC84131C71580DCFD07A1616C9FF536833", "0x76677A9066508541B906945C7EDE71F91D530C76D5706D5728A0D6DCD93455CC", 0, { value: 100 });
        await taskRegister.createBitcoinAddressPrefixTask("1PhoneX", "0xA3F24A728BEFEEC8C597F74EDE3BCFEC84131C71580DCFD07A1616C9FF536833", "0x76677A9066508541B906945C7EDE71F91D530C76D5706D5728A0D6DCD93455CC", 0, { value: 100 });
        await taskRegister.createBitcoinAddressPrefixTask("1PhoneY", "0xA3F24A728BEFEEC8C597F74EDE3BCFEC84131C71580DCFD07A1616C9FF536833", "0x76677A9066508541B906945C7EDE71F91D530C76D5706D5728A0D6DCD93455CC", 0, { value: 100 });
        const taskId = web3.toBigNumber(receipt.logs[0].topics[1]);
    ...
    it("should solve mid of 3 tasks", async function() {
        wallet10.should.be.equal("0x0d65ad88abf613060af3c14a3c33c5142eae687b");
    ...
    it("should solve last of 3 tasks", async function() {
        wallet10.should.be.equal("0x0d65ad88abf613060af3c14a3c33c5142eae687b");
